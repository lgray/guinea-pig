...
void collide_gg(int cellx, int celly, float min_z, const BEAM_PHOTON_POINTER& photon_pointer1, const BEAM_PHOTON_POINTER& photon_pointer2, PAIR_BEAM& secondaries, SWITCHES& switches, RNDM& hasard, double *returnCrossSectionToAdd);
...
void collide_gg_XX(int index_of_process, int cellx, int celly,float min_z, const PHOTON_POINTER& photon1, const PHOTON_POINTER& photon2, SWITCHES& switches, PAIR_BEAM& secondaries, RNDM& hasard, double *returnCrossSectionToAdd);
...
void step_pair_1(const vector<GENERAL_GRID*>& grids, PAIR_PARTICLE& paire,float step,int n, int extra_grids, float charge_sign_0, RNDM& hasard);
...
void photon_lumi(float min_z,SWITCHES& switches, PAIR_BEAM& secondaries, RNDM& hasard);

void photon_lumi_2(float min_z,SWITCHES& switches,PAIR_BEAM& secondaries, RNDM& hasard);
